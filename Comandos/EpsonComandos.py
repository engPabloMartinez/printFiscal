...
##    CMD_PRINT_TEXT_IN_FISCAL = (0x41, 0x61)
    ...
    docTypes = {
        "CUIT": 'DOC_TYPE_CUIT',
        "LIBRETA_ENROLAMIENTO": 'DOC_TYPE_LIBRETA_ENROLAMIENTO',
        "LIBRETA_CIVICA": 'DOC_TYPE_LIBRETA_CIVICA',
        "DNI": 'DNI',
        "PASAPORTE": 'PASAP',
        "CEDULA": 'CED',
        "SIN_CALIFICADOR": 'S/C'
    ...
    def addItem(self, description, quantity, price, iva, porcInterno, importeInternosEpsonB, 
        ...
        reply = self._sendCommand(self.CMD_PRINT_LINE_ITEM[self._getCommandIndex()],
                          [formatText(description[-1][:20]),
                            quantityStr, priceUnitStr, ivaStr, sign, bultosStr, tasaAjuste] + extraparams)
        if discount:
